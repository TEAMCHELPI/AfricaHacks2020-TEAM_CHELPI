  ...
  <div class="relative min-h-screen pt-24 p-3 container mx-auto">
    ...
    <section class="block">
      <header id="mast-head" class="dashboard-hero">
        <button class="block font-head mt-3 p-3 px-8 bg-brand-primary text-white font-medium hover:bg-green-600">
          Setup your banner
        </button>
      </header>
...
<!-- Top meals -->
      ...
      <section class="w-full">
        ...
        <!-- Meals nearby -->
        <section class="flex flex-auto mr-auto py-3 items-baseline space-x-3">
          <span class="font-head lg:text-xl text-right">Meals</span>
          <button class="block font-head mt-3 p-3 px-8 bg-brand-primary text-white font-medium hover:bg-green-600">
            Add meals to menu
          </button>
        </section>
